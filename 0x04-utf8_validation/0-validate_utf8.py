...
def validUTF8(data):
    ...
    for byte in data:
        if num_bytes_to_follow == 0:
            if byte >> 6 == 0b0:  # This is a standalone character
                continue
            elif byte >> 5 == 0b110:
                num_bytes_to_follow = 1
            elif byte >> 4 == 0b1110:
            ...
            else:  # This byte doesn't represent the start of a valid UTF-8 character
                return False
        else:
            if byte >> 6 != 0b10:  # This is not a valid continuation byte
                return False
            num_bytes_to_follow -= 1
